...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "even_division": {"a": "9", "b": "3", "expected": "0"},
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "full": {"a": "5", "b": "5", "expected": "100"},
        "quarter": {"a": "1", "b": "4", "expected": "25"},
        "over_hundred": {"a": "3", "b": "2", "expected": "150"},
        "zero_numerator": {"a": "0", "b": "5", "expected": "0"},
        "decimals": {"a": "1", "b": "3", "expected": "33.33333333333333333333333333"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "5",
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "5", "b": "3", "expected": "2"},
        "reversed_order": {"a": "3", "b": "5", "expected": "2"},
        "negative_numbers": {"a": "-5", "b": "-3", "expected": "2"},
        "mixed_signs": {"a": "-5", "b": "3", "expected": "8"},
